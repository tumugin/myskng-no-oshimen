...
export const oshimens: Oshimen[] = [
  ...
  },
  {
    ...
    shortDescription: 'ｽﾐﾊﾁｬﾝ... よちよちしたいね...',
    description:
      'トナリアのピンク最年少さん。シナモンとアニメと川が好きで、空手は黒帯二段。スミハちゃんをよちよちしよう。',
  ...
  },
  {
    ...
    emoji: '🦕',
    birthday: { month: 1, day: 30 },
    shortDescription: 'ﾙﾉﾝﾁｬﾝ... るんぽこ...',
    description:
      'トナリアの思案ブルー担当。Twitterとおしゃべりとお笑いが好きで、特技はピアノ。るんぽこの言葉は今日もオタクの心を揺らす。',
  ...
  },
  {
    ...
    shortDescription: 'ﾙｶﾁｬﾝ... デカい音を浴びよう...',
    description:
      'PASTEL RADIOの青色担当。クラブサウンドとキレのあるパフォーマンスが最高なので、パスラジでデカい音を浴びよう。',
  ...
  },
  {
    ...
    shortDescription: 'ﾏﾘﾝﾁｬﾝ... 黒髪ｽｰﾊﾟｰﾛﾝｸﾞ...',
    description:
      'PASTEL RADIOの水色担当で、LABOnes.のメイド。黒髪スーパーロングと独特の感性が素敵なマリンちゃん。',
  ...
  },
  {
    ...
    shortDescription: 'ｱﾒｽﾝ... ノイズごと全部受信して...',
    description:
      'LUVRiXのブルーシグナル。ダンスが得意で、アイスと水族館と卵焼きと寝ることが好き。ノイズごと全部受信してくれます。',
  ...
  },
  {
    ...
    shortDescription: 'ﾕﾏﾁｬﾝ... 誰よりも尖ってこーぜ...',
    description:
      'LUVRiXのピンクパルス。「これからも誰よりも、尖ってこーぜ♡」のメッセージ通り、網膜と脳みそに刺さるアイドル。',
